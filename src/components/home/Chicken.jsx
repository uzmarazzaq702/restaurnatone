...
import product from "../../assets/product-3.jpg";

const Chicken = () => {
  return (
    <div
      className="relative bg-pink-50 rounded-2xl overflow-hidden shadow-md flex flex-col md:flex-row p-4 md:p-0 overflow-x-hidden max-w-7xl mx-auto"
    >
      ...
      <div className="flex-1 p-6 md:p-12 flex flex-col justify-center items-center text-center">
        ...
        <h2 className="text-3xl font-bold text-gray-900 mb-4">Chicken Skewers</h2>
        ...
        <div className="flex items-center gap-6 mt-4 flex-wrap justify-center">
          <div className="flex items-center gap-3">
            ...
            <span className="text-lg line-through text-gray-400">$23</span>
          </div>

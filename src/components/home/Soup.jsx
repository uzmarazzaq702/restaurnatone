...
import product from "../../assets/product-22.jpg";

const Soup = () => {
  return (
    <div>
      <div className="relative bg-pink-50 rounded-2xl overflow-hidden shadow-md flex flex-col md:flex-row p-4 md:p-0">
        ...
        <div className="flex-1 p-6 md:p-12 flex flex-col justify-center items-center text-center">
          <div className="flex gap-2 mb-3">
            <span className="border border-gray-400 text-xs px-5 py-3 rounded-full hover:bg-[#EA1056] hover:text-white transition duration-300">
              Dinner
            </span>
          </div>
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Thai Soup</h2>

          <p className="text-gray-700 mb-6 text-base leading-relaxed max-w-xl text-[18px]">
            Lorem ipsum dolor sit amet consectetur. Habitasse metus urna risus nunc proin
            dignissim. Tellus fermentum diam the metus viverra netus amet. Turpis pulvinar 
            suscipit vel. Feugiat the pellentesque pellentesque egestas the feugiat.
          </p>
        ...
        {/* Right Image */}
        <div className="md:w-1/2 w-full overflow-hidden rounded-b-2xl md:rounded-r-2xl md:rounded-b-none group">
          <img
            src={product}
            alt="Thai Soup"
